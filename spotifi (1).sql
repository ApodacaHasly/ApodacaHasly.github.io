...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-04-2023 a las 04:23:15
...
--
ALTER TABLE `albunes`
  ADD CONSTRAINT `albunes_ibfk_1` FOREIGN KEY (`id`) REFERENCES `album_canciones` (`album_id`),
  ADD CONSTRAINT `albunes_ibfk_2` FOREIGN KEY (`id`) REFERENCES `favoritas` (`usuario_id`);
...
ALTER TABLE `artistas`
  ...
  ADD CONSTRAINT `artistas_ibfk_2` FOREIGN KEY (`id`) REFERENCES `albunes` (`artistas_id`);

--
-- Filtros para la tabla `favoritas`
--
ALTER TABLE `favoritas`
  ADD CONSTRAINT `favoritas_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `playlist` (`usuario_id`);
...
--
ALTER TABLE `playlist`
  ADD CONSTRAINT `playlist_ibfk_1` FOREIGN KEY (`id`) REFERENCES `playlist_canciones` (`playlist_id`);

--
-- Filtros para la tabla `playlist_canciones`
--
ALTER TABLE `playlist_canciones`
  ADD CONSTRAINT `playlist_canciones_ibfk_1` FOREIGN KEY (`cancion_id`) REFERENCES `albunes` (`id`);
COMMIT;
